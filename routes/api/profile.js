...
router.put(
  ...
  [
    ...
    [
      ...
      check("from", "From date is required is required").not().isEmpty(),
      check("current", "Current is required is required").not().isEmpty(),
    ],
  ],
  async (req, res) => {
    const errors = validationResult(req);
...
// @route   DELETE api/profiles/education/:ed_id
